...
?>					
					<div id="copy">
						<p>
						<span style="float: left; text-align: left; width: 70%;">© Morenja HOSTING SOLUTION All rights reserved. / Designed and coded by <a href="#">Filip Veličković</a>. </span> <span style="float: left; width: 29%; text-align: right;">Stranica učitana za: <a><?php echo $pageload; ?>s</a> | Verzija: <?php echo $verzija['value']; ?></a></span>
						</p>
					</div>
				</div>   	
		</footer>
