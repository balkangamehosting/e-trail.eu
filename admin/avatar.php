...
if($_GET['mode'] == "a")
{
	...
	{
		$image = imagecreatefrompng("http://insomnia-community.info/avatari/noavatar.png");
	...
	else
	{
		...
		$imagepath = "http://insomnia-community.info/admin/avatari/{$id}.{$ext}";
...
else if($_GET['mode'] == "c")
{
	...
	else
	{
		...
		$imagepath = "http://insomnia-community.info/avatari/{$id}.{$ext}";
