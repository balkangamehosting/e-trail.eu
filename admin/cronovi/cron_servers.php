...
{
	file_get_contents("http://morenja.info/admin/srv-grafik.php?id={$row[id]}&cron=C#3gtQ@");
	file_get_contents("http://morenja.info/gp-srvgrafik.php?id={$row[id]}&cron=aX21$%@");
	file_get_contents("http://morenja.info/gp-banner.php?id={$row[id]}&cron=6123saxhGASD");
}
