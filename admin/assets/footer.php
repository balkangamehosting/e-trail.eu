		...
		<div class="container">
			...
			<div class="row">
				...
				<div id="footer-copyright" class="span6">
					&copy; <m>Morenja HOSTING</m> SOLUTION All rights reserved.
				</div> <!-- /span6 -->
				
				<div id="footer-terms" class="span6">
					<i class="icon-html5 icon-2x"></i><span style="margin-left: 10px;">Kodirao <a href="http://morenja.com" target="_blank">Alen Morenjačkić</a></span>
				</div> <!-- /.span6 -->
	...
	<div class="modal-body">
		<form action="process.php" method="post" id="validation-form" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="datacentar" class="span5" type="text" placeholder="Morenja">
				</div>
			</div>	
